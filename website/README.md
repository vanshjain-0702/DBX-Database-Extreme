...
**Show demo video:** [Walkthrough](https://dbxdb.co.in/demo.html) (`demo.html` + [`assets/vector-search.mp4`](assets/vector-search.mp4) recall clip + [`assets/demo.mp4`](assets/demo.mp4) product tour). Also linked from the root [README](../README.md).
