...
def main():
    ...
    config = {
        ...
        "split": "train",
        "text_column": "text",
        "limit": 50000 # The big website simulation dataset size
    }
    ...
    print(f"✅ Successfully indexed {total_docs} documents into DBX in {time.time() - t0:.2f}s!")
    print(f"Average ingestion speed: {total_docs / (time.time() - t0):.2f} docs/sec (including local embedding time)")
