...
def main():
    ...
    try:
        ...
        print("DBX server is not running on 6399 or certs are missing. Start the server first!")
        sys.exit(1)
    ...
    print(f"Ingestion complete. Time: {ingest_time:.2f}s | Speed: {n_samples/ingest_time:.2f} ops/sec")
